...
namespace EStoreDAL
{
    public class UserService
    {
        ...
        {
            UserManager<ApplicationUser> appUsrMgr = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new AppDbContext()));
            SignInManager<ApplicationUser, string> sinMgr = new SignInManager<ApplicationUser, string>(appUsrMgr, authMgr);
